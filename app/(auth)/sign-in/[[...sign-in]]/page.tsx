          ...
          <div className="w-full rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-900 shadow-lg text-center space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
                Add your real Clerk keys to <code className="font-mono font-semibold bg-zinc-100 dark:bg-zinc-800 px-1 py-0.5 rounded">.env</code> to activate live user sign in.
              </p>
            </div>
            <Link
              href="/dashboard"
